# Contributing to Geokode

Thank you for your interest in contributing to Geokode!

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone git@github.com:YOUR_USERNAME/geokode.git`
...
- **Linting**: `cargo clippy --all-targets -- -D warnings` must pass cleanly
